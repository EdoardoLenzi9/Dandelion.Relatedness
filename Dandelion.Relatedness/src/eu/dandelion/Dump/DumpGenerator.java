...
public class DumpGenerator {
    ...
    public static void Generate(int maxId, int nodeSize, double nullPercentage, double avgRel) throws FileNotFoundException, UnsupportedEncodingException {
    ...
    public static String randomPostingList(int nodeSize, int relForNode, int currentIndex) {
